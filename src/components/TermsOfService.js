    ...
    return (
        <div className="container">
            <div className="card">
                ...
                <p>By using the Spotify Playlist Mixer app, you agree to these terms.</p>
                ...
                <ul>
                    ...
                    <li>Operates entirely in your browser using Spotify's official API</li>
                </ul>
                ...
                <h2>Termination</h2>
                <p>You may stop using the service anytime by revoking access in your Spotify account settings.</p>
            </div>
        </div>
    );
};
